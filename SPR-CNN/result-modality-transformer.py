...
y3 = [0.039645493030548096, 0.02747759222984314, 0.019949764013290405, 0.016258176416158676, 0.01421394757926464, 0.013869925402104855, 0.01333386730402708]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y3 = [15.49264954985823, 15.603153955212745, 15.671097689190924, 15.70430017748037, 15.722653260234654, 15.725739653022522, 15.730547503306035]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y2 = [0.039645493030548096, 0.02747759222984314, 0.019949764013290405, 0.016258176416158676, 0.01421394757926464, 0.013869925402104855, 0.01333386730402708]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y2 = [15.49264954985823, 15.603153955212745, 15.671097689190924, 15.70430017748037, 15.722653260234654, 15.725739653022522, 15.730547503306035]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y1 = [0.039645493030548096, 0.02747759222984314, 0.019949764013290405, 0.016258176416158676, 0.01421394757926464, 0.013869925402104855, 0.01333386730402708]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y4 = [0.03975171595811844, 0.027584269642829895, 0.020740732550621033, 0.01648659072816372, 0.014851024374365807, 0.014450356364250183, 0.013560788705945015]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y1 = [15.49264954985823, 15.603153955212745, 15.671097689190924, 15.70430017748037, 15.722653260234654, 15.725739653022522, 15.730547503306035]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y4 = [15.491681067760004, 15.602188908767813, 15.663973687062441, 15.702248021962497, 15.716936093266758, 15.720532003327762, 15.728512427221728]
