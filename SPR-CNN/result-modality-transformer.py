...
y2 = [0.04010997712612152, 0.030061252415180206, 0.02286352589726448, 0.018579063937067986, 0.016204895451664925, 0.015272018499672413, 0.014378390274941921]
...
y3 = [0.039645493030548096, 0.02848387509584427, 0.02129441872239113, 0.017665809020400047, 0.015258733183145523, 0.01451767235994339, 0.013874311000108719]
...
# reshape type = (Nr, Nt, channel)
# 自己寫的 multi-head attention
y2 = [15.488414550056097, 15.579760882190199, 15.64483701235907, 15.68343480874185, 15.70477877832414, 15.713156822752882, 15.721177762372365]

# Transformers(Encoder * 2 + Decoder * 2, (16 * 32 * 4)), epochs = 200, lr = 0.0001, batch_size = 32
# 自己寫的 multi-head self attention, full attention
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y3 = [15.49264954985823, 15.594047444695512, 15.658984741992914, 15.691648785427166, 15.713276056208183, 15.719927910290641, 15.725700256494086]
...
# reshape type = (Nr, Nt, channel)
# 自己寫的 multi-head attention
y1 = [0.04010997712612152, 0.030061252415180206, 0.02286352589726448, 0.018579063937067986, 0.016204895451664925, 0.015272018499672413, 0.014378390274941921]

# Transformers(Encoder * 2 + Decoder * 2, (16 * 32 * 4)), epochs = 200, lr = 0.0001, batch_size = 32
# 自己寫的 multi-head self attention, full attention
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y2 = [0.039645493030548096, 0.02848387509584427, 0.02129441872239113, 0.017665809020400047, 0.015258733183145523, 0.01451767235994339, 0.013874311000108719]

# Transformers(Encoder * 2 + Decoder * 2, (16 * 32 * 4)), epochs = 200, lr = 0.0001, batch_size = 32
# 自己寫的 multi-head self attention, full attention
# encoder ff layer 用 ffn, decoder ff layer 用 ffn
# modality-aware transformers
y3 = [0.039773717522621155, 0.028461197391152382, 0.021421413868665695, 0.017966583371162415, 0.01585640199482441, 0.014552067965269089, 0.014185205101966858]
...
# reshape type = (Nr, Nt, channel)
# 自己寫的 multi-head attention
y1 = [15.488414550056097, 15.579760882190199, 15.64483701235907, 15.68343480874185, 15.70477877832414, 15.713156822752882, 15.721177762372365]

# Transformers(Encoder * 2 + Decoder * 2, (16 * 32 * 4)), epochs = 200, lr = 0.0001, batch_size = 32
# 自己寫的 multi-head self attention, full attention
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y2 = [15.49264954985823, 15.594047444695512, 15.658984741992914, 15.691648785427166, 15.713276056208183, 15.719927910290641, 15.725700256494086]

# Transformers(Encoder * 2 + Decoder * 2, (16 * 32 * 4)), epochs = 200, lr = 0.0001, batch_size = 32
# 自己寫的 multi-head self attention, full attention
# encoder ff layer 用 ffn, decoder ff layer 用 ffn
# modality-aware transformers
y3 = [15.49148045194048, 15.594252673970859, 15.657840168742075, 15.688944079251307, 15.707909134999468, 15.719619257954932, 15.722911156969142]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y1 = [0.039645493030548096, 0.02848387509584427, 0.02129441872239113, 0.017665809020400047, 0.015258733183145523, 0.01451767235994339, 0.013874311000108719]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y1 = [15.49264954985823, 15.594047444695512, 15.658984741992914, 15.691648785427166, 15.713276056208183, 15.719927910290641, 15.725700256494086]
