...
y3 = [0.039645493030548096, 0.02747759222984314, 0.019949764013290405, 0.016258176416158676, 0.014825291931629181, 0.013869925402104855, 0.01333386730402708]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y3 = [15.49264954985823, 15.603153955212745, 15.671097689190924, 15.70430017748037, 15.717167092546497, 15.725739653022522, 15.730547503306035]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y2 = [0.039645493030548096, 0.02747759222984314, 0.019949764013290405, 0.016258176416158676, 0.014825291931629181, 0.013869925402104855, 0.01333386730402708]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y2 = [15.49264954985823, 15.603153955212745, 15.671097689190924, 15.70430017748037, 15.717167092546497, 15.725739653022522, 15.730547503306035]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y1 = [0.039645493030548096, 0.02747759222984314, 0.019949764013290405, 0.016258176416158676, 0.014825291931629181, 0.013869925402104855, 0.01333386730402708]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y3 = [0.04016707092523575, 0.03142015263438225, 0.020967191085219383, 0.01693073660135269, 0.014729450456798077, 0.014260709285736084, 0.013719967566430569]

# Transformers(Encoder * 2 + Decoder * 2, (16 * 32 * 4)), epochs = 200, lr = 0.0001, batch_size = 32
# 自己寫的 multi-head self attention, Stride Sparse Self Attention
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y4 = [0.03975171595811844, 0.02894938737154007, 0.020740732550621033, 0.01648659072816372, 0.014851024374365807, 0.013610122725367546, 0.013560788705945015]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y1 = [15.49264954985823, 15.603153955212745, 15.671097689190924, 15.70430017748037, 15.717167092546497, 15.725739653022522, 15.730547503306035]
...
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y3 = [15.487893916991833, 15.567441829124121, 15.661933478931305, 15.698256769090925, 15.718027282607842, 15.722233706836965, 15.727084762060883]

# Transformers(Encoder * 2 + Decoder * 2, (16 * 32 * 4)), epochs = 200, lr = 0.0001, batch_size = 32
# 自己寫的 multi-head self attention, Stride Sparse Self Attention
# encoder ff layer 用 Conv1D, decoder ff layer 用 ffn
# modality-aware transformers
y4 = [15.491681067760004, 15.589832575098683, 15.663973687062441, 15.702248021962497, 15.716936093266758, 15.728069976733451, 15.728512427221728]
